...
public class HumiditySensor {
    ...
    public HumiditySensor(String broker, String clientId, String topic, int qos) throws MqttException {
    ...
    public void publishHumidity(double humidity) throws MqttException {
        // create a message with the humidity value as the payload
        MqttMessage message = new MqttMessage(String.valueOf(humidity).getBytes());
